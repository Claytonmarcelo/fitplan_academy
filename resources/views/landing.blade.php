        ...
        <section id="planos" class="bg-background-light dark:bg-zinc-900 py-16 md:py-24">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white dark:bg-background-dark border border-zinc-200 dark:border-zinc-800 rounded-xl p-8 flex flex-col {{ $plan->name === 'Smart' ? 'bg-primary text-white relative overflow-hidden' : '' }}">
                        @if($plan->name === 'Smart')
                        ...
                        <form action="{{ route('checkout', $plan->id) }}" method="GET">
                            <button type="submit" class="w-full py-3 font-bold {{ $plan->name === 'Smart' ? 'text-primary bg-white hover:bg-white/90' : 'text-primary bg-primary/10 dark:bg-primary/20 hover:bg-primary/20 dark:hover:bg-primary/30' }} rounded-lg transition-colors">
                                Selecionar Plano
                            </button>
                        </form>
