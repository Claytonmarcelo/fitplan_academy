    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <a href="{{ route('plan.basic') }}" class="block w-full text-center px-4 py-2 bg-orange-500 text-white rounded-lg mt-4">Escolher Basic</a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 ring-2 ring-orange-500">
                ...
                <a href="{{ route('plan.smart') }}" class="block w-full text-center px-4 py-2 bg-orange-500 text-white rounded-lg mt-4">Escolher Smart</a>
            </div>
            
            <div class="bg-white rounded-lg shadow-sm p-6">
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Black</h3>
                <p class="text-gray-600">R$ 199,90/mês</p>
                <a href="{{ route('plan.black') }}" class="block w-full text-center px-4 py-2 bg-orange-500 text-white rounded-lg mt-4">Escolher Black</a>
            </div>
        </div>
