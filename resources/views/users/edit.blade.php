            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('users.index') }}" class="px-4 py-2 bg-zinc-200 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-300 rounded-lg hover:bg-zinc-300 dark:hover:bg-zinc-600 transition-colors">
                            ← Voltar
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                    <form method="POST" action="{{ route('users.update', $user) }}" class="p-8 space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="role" 
                                        ...
                                        required
                                        class="w-full px-4 py-3 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary">
                                    <option value="common" {{ old('role', $user->role) === 'common' ? 'selected' : '' }}>Usuário Comum</option>
                                    <option value="master" {{ old('role', $user->role) === 'master' ? 'selected' : '' }}>Administrador</option>
                                </select>
                            </div>
                        ...
                        <div class="flex items-center gap-3 pt-6">
                            ...
                            <a href="{{ route('users.index') }}" class="px-4 py-3 bg-zinc-200 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-300 rounded-lg hover:bg-zinc-300 dark:hover:bg-zinc-600 transition-colors">
                                Cancelar
                            </a>
                        </div>
                    </form>
