        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('unit.show', 1) }}" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-primary transition-colors">Centro</a></li>
                    <li><a href="{{ route('unit.show', 2) }}" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-primary transition-colors">Zona Sul</a></li>
                    <li><a href="{{ route('unit.show', 3) }}" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-primary transition-colors">Zona Norte</a></li>
                    <li><a href="{{ route('unit.show', 4) }}" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-primary transition-colors">Zona Oeste</a></li>
                </ul>
            </div>
