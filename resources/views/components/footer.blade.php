        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-xl font-bold text-zinc-900 dark:text-white">FitPlan Academy</h3>
                </div>
                ...
                <div class="flex gap-3">
                    <!-- Facebook -->
                    <a href="#" class="text-zinc-400 hover:text-primary transition-colors" title="Facebook">
                    ...
                    <!-- Instagram -->
                    <a href="#" class="text-zinc-400 hover:text-primary transition-colors" title="Instagram">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- TikTok -->
                    <a href="#" class="text-zinc-400 hover:text-primary transition-colors" title="TikTok">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- YouTube -->
                    <a href="#" class="text-zinc-400 hover:text-primary transition-colors" title="YouTube">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Pinterest -->
                    <a href="#" class="text-zinc-400 hover:text-primary transition-colors" title="Pinterest">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="border-t border-zinc-200 dark:border-zinc-700 mt-8 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex gap-6 text-sm">
                    <a href="{{ route('privacy.policy') }}" class="text-zinc-600 dark:text-zinc-400 hover:text-primary transition-colors">Política de Privacidade</a>
                    <a href="{{ route('terms.service') }}" class="text-zinc-600 dark:text-zinc-400 hover:text-primary transition-colors">Termos de Serviço</a>
