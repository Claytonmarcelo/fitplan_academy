...
<div class="min-h-screen">
    ...
    <main class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div class="relative bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-8 {{ $plan['popular'] ? 'ring-2 ring-primary' : '' }}">
                @if($plan['popular'])
                ...
                <div class="text-center mb-6">
                    <h3 class="text-2xl font-bold text-zinc-900 dark:text-white mb-2">{{ $plan['name'] }}</h3>
                ...
                <div class="space-y-4 mb-8">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="w-5 h-5 rounded-full flex items-center justify-center {{ $feature[$plan['id']] ? 'bg-green-500' : 'bg-zinc-300 dark:bg-zinc-600' }}">
                                @if($feature[$plan['id']])
                            ...
                            <span class="text-sm font-medium text-zinc-900 dark:text-white">{{ $feature['name'] }}</span>
                        </div>
                    </div>
                    @endforeach
                </div>
                        ...
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-700/50">
                            <td class="px-6 py-4">
                                <div>
                                    ...
                                    <div class="text-sm text-zinc-500 dark:text-zinc-400">{{ $feature['description'] }}</div>
                                </div>
                            </td>
