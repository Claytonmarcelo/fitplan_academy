                        ...
                        <form action="<?php echo e(route('contact.send')); ?>" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="message" 
                                          ...
                                          class="w-full px-4 py-3 border border-zinc-300 dark:border-zinc-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white placeholder-zinc-500 dark:placeholder-zinc-400 transition-colors resize-none"><?php echo e(old('message')); ?></textarea>
                            </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="<?php echo e(route('landing')); ?>" class="text-zinc-400 hover:text-white transition-colors">Home</a></li>
                        <li><a href="<?php echo e(route('landing')); ?>#planos" class="text-zinc-400 hover:text-white transition-colors">Planos</a></li>
                        <li><a href="<?php echo e(route('units.index')); ?>" class="text-zinc-400 hover:text-white transition-colors">Unidades</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>" class="text-zinc-400 hover:text-white transition-colors">Contato</a></li>
                    </ul>
                </div>
...
<?php /**PATH /Users/eduardocruz/fitplan_acadamy/resources/views/contact.blade.php ENDPATH**/ ?>