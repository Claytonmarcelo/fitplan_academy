...
<head>
    ...
    <title><?php echo e($unit['name']); ?> - FitPlan Academy</title>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center gap-8">
                    <a class="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('landing')); ?>">Home</a>
                    <a class="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('landing')); ?>#planos">Planos</a>
                    <a class="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('landing')); ?>#comparacao">Comparação</a>
                    <a class="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('landing')); ?>#locais">Locais</a>
                </nav>
    ...
    <main>
        ...
        <section class="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="flex flex-col gap-6">
                    <h1 class="text-4xl md:text-6xl font-black tracking-tighter text-zinc-900 dark:text-white"><?php echo e($unit['name']); ?></h1>
                    <p class="text-lg text-zinc-600 dark:text-zinc-300"><?php echo e($unit['description']); ?></p>
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-2">
                            <svg class="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path>
                            </svg>
                            <span class="text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($unit['address']); ?></span>
                        </div>
                    </div>
                ...
                <div class="w-full aspect-video bg-cover bg-center rounded-xl" style='background-image: url("<?php echo e($unit['image']); ?>");'></div>
            </div>
        </section>
        ...
        <section class="bg-background-light dark:bg-zinc-900 py-16 md:py-24">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $unit['features']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white dark:bg-background-dark border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="font-semibold text-zinc-900 dark:text-white"><?php echo e($feature); ?></h3>
                        </div>
                    </div>
        ...
        <section class="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php $__currentLoopData = $unit['equipment']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white dark:bg-background-dark border border-zinc-200 dark:border-zinc-800 rounded-lg p-4 text-center">
                    ...
                    <p class="text-sm text-zinc-600 dark:text-zinc-300"><?php echo e($equipment); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </section>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white dark:bg-background-dark border border-zinc-200 dark:border-zinc-800 rounded-lg p-6 text-center">
                        ...
                        <h3 class="font-semibold text-zinc-900 dark:text-white mb-2"><?php echo e($class); ?></h3>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        ...
        <section class="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <div class="bg-white dark:bg-background-dark border border-zinc-200 dark:border-zinc-800 rounded-xl p-8">
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $unit['hours']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path>
                            </svg>
                            <span class="text-zinc-600 dark:text-zinc-300"><?php echo e($hour); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-background-dark border border-zinc-200 dark:border-zinc-800 rounded-xl p-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-zinc-600 dark:text-zinc-300"><?php echo e($unit['contact']['phone']); ?></span>
                        </div>
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span class="text-zinc-600 dark:text-zinc-300"><?php echo e($unit['contact']['email']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Other Units Section -->
        <?php if(count($otherUnits) > 0): ?>
        <section class="bg-background-light dark:bg-zinc-900 py-16 md:py-24">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl md:text-4xl font-bold text-center mb-12 text-zinc-900 dark:text-white">Outras Unidades</h2>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $otherUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherUnit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white dark:bg-background-dark border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden">
                        <div class="w-full h-48 bg-cover bg-center" style='background-image: url("<?php echo e($otherUnit['image']); ?>");'></div>
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-zinc-900 dark:text-white mb-2"><?php echo e($otherUnit['name']); ?></h3>
                            <p class="text-sm text-zinc-600 dark:text-zinc-400 mb-4"><?php echo e($otherUnit['address']); ?></p>
                            <a href="<?php echo e(route('unit.show', $otherUnit['id'])); ?>" class="inline-flex items-center text-primary hover:text-primary/80 transition-colors">
                                Ver <?php echo e($otherUnit['name']); ?> →
                            </a>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /Users/eduardocruz/fitplan_acadamy/resources/views/units/show.blade.php ENDPATH**/ ?>