...
<head>
    ...
    <title><?php echo e($semPlano ? 'Cadastre-se - FitPlan Academy' : 'Cadastro - FitPlan Academy'); ?></title>
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-12">
                    <h1 class="text-4xl md:text-5xl font-black tracking-tight text-zinc-900 dark:text-white mb-4">
                        <?php echo e($semPlano ? 'Cadastre-se' : 'Cadastro'); ?>

                    </h1>
                    <p class="text-lg text-zinc-600 dark:text-zinc-300 mb-8">
                        <?php echo e($semPlano ? 'Complete seu cadastro e comece sua jornada fitness hoje mesmo!' : 'Crie sua conta no FitPlan Academy'); ?>
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                    <form method="POST" action="<?php echo e(route('auth.register')); ?>" class="p-8 space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="gender" 
                                    ...
                                    <option value="O" <?php echo e(old('gender') == 'O' ? 'selected' : ''); ?>>Outro</option>
                                </select>
                            </div>
                ...
                <div class="text-center mt-8">
                    <p class="text-zinc-600 dark:text-zinc-400">
                        Já tem uma conta? 
                        <a href="<?php echo e(route('login')); ?>" class="text-primary hover:text-primary/80 font-medium transition-colors">Faça login aqui</a>
                    </p>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /Users/eduardocruz/fitplan_acadamy/resources/views/auth/register.blade.php ENDPATH**/ ?>