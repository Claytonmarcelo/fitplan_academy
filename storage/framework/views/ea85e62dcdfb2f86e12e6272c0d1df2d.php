...
<body>
    ...
    <div class="footer">
        <p>Total de usuários: <?php echo e($users->count()); ?></p>
        <p>FitPlan Academy - Sistema de Gestão de Academia</p>
    </div>
</body>
</html>

<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/fitplan_acadamy/resources/views/users/pdf.blade.php ENDPATH**/ ?>