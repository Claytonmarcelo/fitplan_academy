    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-2">
                <?php if(auth()->check()): ?>
                    <span class="text-sm text-zinc-600 dark:text-zinc-300">Olá, <?php echo e(auth()->user()->name); ?></span>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/fitplan_acadamy/resources/views/components/header-working.blade.php ENDPATH**/ ?>