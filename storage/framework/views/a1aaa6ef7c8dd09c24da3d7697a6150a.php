            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <nav class="hidden md:flex items-center gap-6 text-sm font-medium">
                        <a class="text-zinc-700 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('dashboard')); ?>">
                            Home
                        </a>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute right-0 top-12 hidden group-hover:block bg-white dark:bg-zinc-800 shadow-lg rounded-lg py-2 min-w-[200px] z-50">
                                <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="block px-4 py-2 text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700">
                                    <span class="material-symbols-outlined text-sm mr-2">person</span>
                                    Meu Perfil
                                </a>
                                <a href="<?php echo e(route('change-password')); ?>" class="block px-4 py-2 text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700">
                                    <span class="material-symbols-outlined text-sm mr-2">lock</span>
                                    Alterar Senha
                                </a>
                                <hr class="my-2 border-zinc-200 dark:border-zinc-700">
                                <a href="<?php echo e(route('logout')); ?>" class="block px-4 py-2 text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700">
        ...
        <main class="flex-grow">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
                <h2 class="text-4xl font-bold tracking-tight text-zinc-900 dark:text-white mb-8">
                    Olá, <?php echo e(explode(' ', $user->name)[0]); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 flex flex-col justify-between hover:shadow-lg hover:border-primary/30 dark:hover:border-primary/40 transition-all duration-300">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-zinc-900 dark:text-white">
                                <?php echo e($stats['frequency_this_month'] ?? 12); ?>
                    ...
                    <div class="bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 flex flex-col justify-between hover:shadow-lg hover:border-primary/30 dark:hover:border-primary/40 transition-all duration-300">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-zinc-900 dark:text-white">
                                <?php echo e(date('d') + 10); ?> de <?php echo e(date('M', strtotime('+1 month'))); ?>
                    ...
                    <div class="bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 flex flex-col justify-between hover:shadow-lg hover:border-primary/30 dark:hover:border-primary/40 transition-all duration-300">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-zinc-900 dark:text-white">
                                <?php echo e($stats['goal_progress'] ?? 75); ?>%
                            </p>
                        </div>
                        <div class="mt-4">
                            <svg class="sparkline" viewBox="0 0 100 30" xmlns="http://www.w3.org/2000/svg">
...
<?php /**PATH /Users/eduardocruz/fitplan_acadamy/resources/views/student-dashboard.blade.php ENDPATH**/ ?>