        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-4 py-2 bg-zinc-200 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-300 rounded-lg hover:bg-zinc-300 dark:hover:bg-zinc-600 transition-colors">
                            ← Voltar
                        </a>
                        <a href="<?php echo e(route('system-logs.export', request()->query())); ?>" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
                            📥 Exportar CSV
                        </a>
                        <a href="<?php echo e(route('system-logs.export-pdf', request()->query())); ?>" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
                            📄 Gerar PDF
                        </a>
                        <a href="<?php echo e(route('system-logs.export-excel', request()->query())); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                            📊 Gerar Excel
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-zinc-900 dark:text-white"><?php echo e(number_format($stats['total_access_logs'] ?? 0)); ?></p>
                        </div>
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-600"><?php echo e(number_format($stats['successful_logins'] ?? 0)); ?></p>
                        </div>
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-red-600"><?php echo e(number_format($stats['failed_logins'] ?? 0)); ?></p>
                        </div>
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-blue-600"><?php echo e(number_format($stats['total_logins_today'] ?? 0)); ?></p>
                        </div>
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6 mb-8">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="user_cpf" 
                               value="<?php echo e(request('user_cpf')); ?>"
                    ...
                    <div>
                        ...
                        <select name="successful" class="w-full px-4 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary">
                            ...
                            <option value="1" <?php echo e(request('successful') === '1' ? 'selected' : ''); ?>>Sucesso</option>
                            <option value="0" <?php echo e(request('successful') === '0' ? 'selected' : ''); ?>>Falha</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="two_factor" class="w-full px-4 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary">
                            <option value="">Todos</option>
                            <option value="1" <?php echo e(request('two_factor') === '1' ? 'selected' : ''); ?>>Com 2FA</option>
                            <option value="0" <?php echo e(request('two_factor') === '0' ? 'selected' : ''); ?>>Sem 2FA</option>
                        </select>
                    </div>
                    <div class="flex items-end gap-2">
                        ...
                        <a href="<?php echo e(route('system-logs.index')); ?>" class="px-4 py-2 bg-zinc-200 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-300 rounded-lg hover:bg-zinc-300 dark:hover:bg-zinc-600 transition-colors">
                            🔄 Limpar
                        </a>
                    </div>
                </form>
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg overflow-hidden">
                <div class="p-6 border-b border-zinc-200 dark:border-zinc-700">
                    ...
                    <p class="text-sm text-zinc-600 dark:text-zinc-400 mt-1">Total: <?php echo e($accessLogs->total()); ?> registros</p>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="bg-white dark:bg-zinc-800 divide-y divide-zinc-200 dark:divide-zinc-700">
                            <?php $__empty_1 = true; $__currentLoopData = $accessLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-zinc-600 dark:text-zinc-400">
                                    <?php echo e($log->user_cpf); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <code class="px-2 py-1 bg-zinc-100 dark:bg-zinc-700 rounded text-zinc-900 dark:text-zinc-200"><?php echo e($log->user_login); ?></code>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-zinc-600 dark:text-zinc-400">
                ...
                <!-- Pagination -->
                <?php if($accessLogs->hasPages()): ?>
                <div class="px-6 py-4 border-t border-zinc-200 dark:border-zinc-700">
                    <?php echo e($accessLogs->appends(request()->query())->links()); ?>
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-700 rounded-lg">
                            <div class="flex items-center gap-3">
                                <?php if($log['type'] === 'access'): ?>
                                    <div class="w-2 h-2 rounded-full <?php echo e($log['successful'] ? 'bg-green-500' : 'bg-red-500'); ?>"></div>
                                <?php else: ?>
                                    <div class="w-2 h-2 rounded-full bg-blue-500"></div>
                                <?php endif; ?>
                                <div>
                                    <p class="text-sm font-medium text-zinc-900 dark:text-white"><?php echo e($log['action']); ?></p>
                                    <p class="text-xs text-zinc-600 dark:text-zinc-400">
                                        <?php echo e($log['user_name']); ?> (<?php echo e($log['user_login']); ?>)
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/fitplan_acadamy/resources/views/admin/system-logs.blade.php ENDPATH**/ ?>