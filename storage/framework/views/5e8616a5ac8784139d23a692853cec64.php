            ...
            <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 px-6 py-4 border-b border-zinc-200 dark:border-zinc-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-zinc-900 dark:text-white"><?php echo e($plan['name']); ?></h2>
                            <p class="text-zinc-600 dark:text-zinc-400"><?php echo e($plan['description']); ?></p>
                        </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php $__currentLoopData = $benefits[$plan['id']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start gap-4 p-4 bg-zinc-50 dark:bg-zinc-700/50 rounded-lg">
                            <div class="text-2xl"><?php echo e($benefit['icon']); ?></div>
                            <div>
                                <h3 class="font-semibold text-zinc-900 dark:text-white mb-1"><?php echo e($benefit['name']); ?></h3>
                                <p class="text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($benefit['description']); ?></p>
                            </div>
                        </div>
                ...
                <div class="px-6 py-4 bg-zinc-50 dark:bg-zinc-700/50">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-zinc-600 dark:text-zinc-400">
                            <?php echo e(count($benefits[$plan['id']])); ?> benefícios inclusos
                        </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="text-center">
                        <h3 class="text-lg font-semibold text-zinc-900 dark:text-white mb-4"><?php echo e($plan['name']); ?></h3>
                        ...
                        <div class="mb-6">
                            <div class="w-20 h-20 mx-auto bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center">
                                <span class="text-2xl font-bold text-primary"><?php echo e(count($benefits[$plan['id']])); ?></span>
                            </div>
                        ...
                        <div class="space-y-2 text-left">
                            <?php $__currentLoopData = array_slice($benefits[$plan['id']], 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-primary"></div>
                                <span class="text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($benefit['name']); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if(count($benefits[$plan['id']]) > 5): ?>
                            <div class="text-sm text-zinc-500 dark:text-zinc-400 italic">
                                +<?php echo e(count($benefits[$plan['id']]) - 5); ?> outros benefícios
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="mt-12 text-center">
            <div class="bg-primary/10 dark:bg-primary/20 rounded-xl p-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="<?php echo e(route('comparison.index')); ?>" class="bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700 text-zinc-900 dark:text-white font-semibold py-3 px-8 rounded-lg transition-colors border border-zinc-300 dark:border-zinc-600">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/fitplan_acadamy/resources/views/comparison/benefits.blade.php ENDPATH**/ ?>