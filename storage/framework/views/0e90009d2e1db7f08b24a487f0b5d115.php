    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <nav class="hidden md:flex items-center gap-8">
                <?php if(session()->has('demo_user')): ?>
                    <!-- Navegação para usuários logados -->
                    <a class="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('student.dashboard')); ?>">Home</a>
                    <a class="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('workouts.index')); ?>">Treinos</a>
                    <a class="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('classes.index')); ?>">Aulas</a>
                    <a class="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('challenges.index')); ?>">Desafios</a>
                    <a class="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-primary transition-colors" href="<?php echo e(route('community.index')); ?>">Comunidade</a>
                <?php else: ?>
                            ...
                            <div class="py-2">
                                <!-- Planos hardcoded para consistência -->
                                    ...
                                    <div class="px-4 py-3 dropdown-item hover:bg-zinc-50 dark:hover:bg-zinc-700 border-l-4 border-zinc-300 dark:border-zinc-600">
                                        <a href="<?php echo e(route('plan.basic')); ?>" class="block">
                                    ...
                                    <div class="px-4 py-3 dropdown-item hover:bg-zinc-50 dark:hover:bg-zinc-700 border-l-4 border-orange-500">
                                        <a href="<?php echo e(route('plan.smart')); ?>" class="block">
                                    ...
                                    <div class="px-4 py-3 dropdown-item hover:bg-zinc-50 dark:hover:bg-zinc-700 border-l-4 border-zinc-800 dark:border-zinc-200">
                                        <a href="<?php echo e(route('plan.black')); ?>" class="block">
                        ...
                        <div class="absolute top-full left-0 mt-2 w-64 bg-white/95 dark:bg-zinc-800/95 dropdown-menu custom-shadow rounded-lg border border-zinc-200 dark:border-zinc-700 opacity-0 invisible transition-all duration-300 group-hover:opacity-100 group-hover:visible transform translate-y-2 group-hover:translate-y-0">
                            <div class="py-2">
                                <div class="px-4 py-3 dropdown-item hover:bg-zinc-50 dark:hover:bg-zinc-700 border-l-4 border-primary">
                                    <a href="<?php echo e(route('comparison.index')); ?>" class="block">
                                ...
                                <div class="px-4 py-3 dropdown-item hover:bg-zinc-50 dark:hover:bg-zinc-700 border-l-4 border-zinc-300 dark:border-zinc-600">
                                    <a href="<?php echo e(route('comparison.prices')); ?>" class="block">
                                ...
                                <div class="px-4 py-3 dropdown-item hover:bg-zinc-50 dark:hover:bg-zinc-700 border-l-4 border-zinc-300 dark:border-zinc-600">
                                    <a href="<?php echo e(route('comparison.benefits')); ?>" class="block">
                                ...
                                <div class="border-t border-zinc-200 dark:border-zinc-700 mt-2 pt-2 mx-4">
                                    <a href="<?php echo e(route('comparison.index')); ?>" class="block px-4 py-2 text-sm font-medium text-primary hover:text-primary/80 transition-colors dropdown-item">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/fitplan_acadamy/resources/views/components/header.blade.php ENDPATH**/ ?>