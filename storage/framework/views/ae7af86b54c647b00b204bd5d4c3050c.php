    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="<?php echo e(route('logout')); ?>" class="btn btn-outline-light btn-sm">
    ...
    <div class="container-fluid">
        <div class="content-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="<?php echo e(route('users.pdf')); ?>" class="btn btn-primary me-2">
            ...
            <form method="GET" class="row g-3 mb-4">
                ...
                <div class="col-md-2">
                    <select class="form-select" name="role">
                        ...
                        <option value="master" <?php echo e(request('role') === 'master' ? 'selected' : ''); ?>>Master</option>
                        <option value="common" <?php echo e(request('role') === 'common' ? 'selected' : ''); ?>>Comum</option>
                    </select>
                </div>
                <div class="col-md-2">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><code><?php echo e($user->login); ?></code></td>
                            <td>
                            ...
                            <td>
                                <a href="<?php echo e(route('users.show', $user)); ?>" class="btn btn-sm btn-primary">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('users.edit', $user)); ?>" class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <?php if(Auth::user()->isMaster() && !$user->isMaster() && Auth::id() !== $user->id): ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/fitplan_acadamy/resources/views/users/index.blade.php ENDPATH**/ ?>