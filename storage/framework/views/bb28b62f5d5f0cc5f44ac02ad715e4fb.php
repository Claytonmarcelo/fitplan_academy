        ...
        <section class="container mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-background-dark border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                    <div class="w-full h-64 bg-cover bg-center" style='background-image: url("<?php echo e($unit['image']); ?>");'></div>
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-zinc-900 dark:text-white mb-2"><?php echo e($unit['name']); ?></h3>
                        <p class="text-sm text-zinc-600 dark:text-zinc-400 mb-4"><?php echo e($unit['address']); ?></p>
                        <p class="text-sm text-zinc-600 dark:text-zinc-300 mb-6"><?php echo e($unit['description']); ?></p>
                        
                        <!-- Features Preview -->
                        <div class="mb-6">
                            <h4 class="font-semibold text-zinc-900 dark:text-white mb-3">Principais Recursos:</h4>
                            <div class="grid grid-cols-2 gap-2">
                                <?php $__currentLoopData = array_slice($unit['features'], 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-primary flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span class="text-xs text-zinc-600 dark:text-zinc-300"><?php echo e($feature); ?></span>
                                </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = array_slice($unit['classes'], 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-2 py-1 text-xs bg-primary/10 dark:bg-primary/20 text-primary rounded-full"><?php echo e($class); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(count($unit['classes']) > 4): ?>
                                <span class="px-2 py-1 text-xs bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 rounded-full">+<?php echo e(count($unit['classes']) - 4); ?> mais</span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <span class="text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($unit['contact']['phone']); ?></span>
                            </div>
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-primary" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                                </svg>
                                <span class="text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($unit['contact']['email']); ?></span>
                            </div>
                        </div>

                        <a href="<?php echo e(route('unit.show', $unit['id'])); ?>" class="w-full inline-flex items-center justify-center px-4 py-2 text-sm font-bold text-white bg-primary rounded-lg hover:bg-primary/90 transition-colors">
                            Ver Detalhes
                        </a>
                    </div>
                </div>
        ...
        <section class="bg-background-light dark:bg-zinc-900 py-16 md:py-24">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('cadastro')); ?>" class="px-6 py-3 text-base font-bold text-white bg-primary rounded-lg hover:bg-primary/90 transition-colors">Cadastre-se</a>
                    <a href="<?php echo e(route('landing')); ?>#planos" class="px-6 py-3 text-base font-bold text-zinc-600 dark:text-zinc-300 border border-zinc-300 dark:border-zinc-600 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">Ver Planos</a>
                </div>
            </div>
        </section>
    </main>
...
<?php /**PATH /Users/eduardocruz/fitplan_acadamy/resources/views/units/index.blade.php ENDPATH**/ ?>