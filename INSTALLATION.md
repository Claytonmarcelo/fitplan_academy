...
## 🖥️ Como Rodar com XAMPP e Terminal (Windows/Mac)

Se você prefere usar o XAMPP em vez do Docker, siga estes passos rápidos:
...
2.  **Configure o Banco:**
    ...
    *   Crie um banco de dados novo chamado `fitplan_academy`.

3.  **Configure o Projeto:**
    *   No terminal, dentro da pasta do projeto:
    *   Copie o arquivo de exemplo: `cp .env.example .env` (ou `copy .env.example .env` no Windows).
    *   O arquivo já vem configurado para XAMPP (usuário `root`, sem senha).
