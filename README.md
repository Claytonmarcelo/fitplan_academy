CONFLICT (content): Merge conflict# 🏋️‍♂️ FitPlan Academy
...
curl -sSL https://raw.githubusercontent.com/claytonmarcelo/fitplan_acadamy/main/install.sh | bash

# Windows - Execute como administrador
powershell -Command "Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/claytonmarcelo/fitplan_acadamy/main/install-windows.bat' -OutFile 'install-windows.bat'; .\install-windows.bat"
```
